...
function Contact() {
  return (
    <section  className='container element h-screen' name="contact">
       ...
       <div className='mt-16 flex justify-between md:gap-5 md:flex-row flex-col gap-10'>
           <div className='bgimage md:w-1/3 h-52 w-full'>
               <h1 className='font-bold text-2xl my-5'>Let's talk about everything!</h1>
               <p>Don't like forms? Send me an <span className='text-secondary-color'>email</span>. 👋</p>
           </div>

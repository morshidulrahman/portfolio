...
function Home() {
  ...
  return (
    <div name="home" className='element relative overflow-hidden'>
        <Homebg/>
        <div className='text-[#353353] flex flex-col h-screen justify-center items-center w-full container relative'>
          <img src={image} alt={name} className="w-40 h-40 overflow-hidden mb-6"/>

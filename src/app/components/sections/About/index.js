...
function About() {
  ...
  return (
    <section  className='container element ' name="about">
      <div className='mb-10'>
      ...
      <div className='flex justify-between text-[#454360] pt-8 flex-col md:flex-row gap-10 md:gap-0 w-full'>
         ...
         <div className='shadow-xl rounded-xl py-8 px-8 flex md:w-3/4  w-full justify-between bg-white relative about_after md:flex-row flex-col gap-6 md:gap-0'>
